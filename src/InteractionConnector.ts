import { InteractionAdapter, InteractionEventType, InteractionEvent } from './InteractionAdapter';
...
export class InteractionConnector {
  ...
  constructor(emitter: InteractionAdapter) {
    ...
    emitter.addInteractionListener(InteractionEventType.PressStart, this.handlePressStart);
    emitter.addInteractionListener(InteractionEventType.MoveDuringPress, this.handleMoveDuringPress);
    emitter.addInteractionListener(InteractionEventType.PressStop, this.handlePressStop);
    emitter.addInteractionListener(InteractionEventType.Move, this.handleMove);
    emitter.addInteractionListener(InteractionEventType.Press, this.handlePress);
    emitter.addInteractionListener(InteractionEventType.DoublePress, this.handleDoublePress);
    emitter.addInteractionListener(InteractionEventType.Increase, this.handleIncrease);
    emitter.addInteractionListener(InteractionEventType.Decrease, this.handleDecrease);
  }
