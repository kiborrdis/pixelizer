...
describe('BrowserInteractionAdapter', () => {
  ...
  describe('with set interaction element', () => {
    ...
    beforeEach(() => {
      ...
      adapter.addInteractionListener(InteractionEventType.PressStart, pressStartFn);
      adapter.addInteractionListener(InteractionEventType.MoveDuringPress, moveDuringPressFn);
      adapter.addInteractionListener(InteractionEventType.PressStop, pressStopFn);
      ...
      adapter.addInteractionListener(InteractionEventType.Increase, increaseFn);
      adapter.addInteractionListener(InteractionEventType.Decrease, decreaseFn);
